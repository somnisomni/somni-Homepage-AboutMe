<p class="mb-2">Also I am...</p>

<span class="desc-block text-2xl md:text-4xl pb-0 md:pb-2">A <strong class="font-medium">STUDENT</strong></span><br />
<p class="ml-4">in <strong>School of Game</strong></p>
